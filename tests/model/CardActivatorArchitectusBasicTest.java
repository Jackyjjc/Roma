...
public class CardActivatorArchitectusBasicTest extends Test {
    ...
    public void run(GameState gameState, MoveMaker move) throws AssertionError,
        ...
        out.println("Testing Architectus");
        ...
        //===================== test1 ======================
        move.placeCard(Card.ARCHITECTUS, 1);
        ...
        ArchitectusActivator activator = (ArchitectusActivator) move.chooseCardToActivate(1);
        
        //should be free to lay card now
        move.placeCard(Card.MACHINA, 2);
        ...
        //after the activation, should cost you money again
        move.placeCard(Card.ONAGER, 6);
